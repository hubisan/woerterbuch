(:input "Wolke" :lemma "Wolke" :sources
        ((:source "openthesaurus" :lemma "Wolke" :ok t :url
                  "https://www.openthesaurus.de/synonyme/Wolke" :homographs
                  ((:id 1 :lemma "Wolke" :definitions
                        ((:id 1 :lemma "Wolke" :categories nil :synonyms nil)
                         (:id 2 :lemma "Wolke" :categories ("Computer")
                              :synonyms ("Cloud" "Datenwolke" "Rechnerwolke"))))))
         (:source "dwds" :lemma "Wolke" :ok t :url
                  "https://www.dwds.de/wb/Wolke" :homographs
                        ...
                        ((:id 1 :dwds-id "d-1-1" :label "1." :definition
                              ...
                              ((:id 1 :dwds-id "d-1-1-1" :label "a)" :definition
                               ...
                               (:id 2 :dwds-id "d-1-1-2" :label "b)" :definition
                                    ...
                                    ("jmd. fällt (wie) aus allen Wolken (= jmd. ist sehr überrascht)"
                                     ...
                                     "Eine Wolke der Erinnerung flog über sein Gesicht")
                                    :definitions nil)))
                         (:id 2 :dwds-id "d-1-2" :label "2." :definition
                              "Schwaden" :qualifiers nil :examples nil
                              :definitions
                         ...
                         (:id 3 :dwds-id "d-1-3" :label "3." :definition
                              ...
                              ((:id 1 :dwds-id "d-1-3-1" :label "a)" :definition
                                    "intensiver Geruch, Duftwolke" :qualifiers
                                    nil :examples
                               ...
                               (:id 3 :dwds-id "d-1-3-3" :label "c)" :definition
                                    ...
                                    :definitions nil)
                               (:id 4 :dwds-id "d-1-3-4" :label "d)" :definition
                         ...
                         (:id 4 :dwds-id "d-1-4" :label "4." :definition
                              "⟨das ist ’ne Wolke⟩ drückt begeisterte Anerkennung, großes Lob aus"
                              :qualifiers ("berlinisch" "salopp") :examples
                              ("deine Mutter, die neue Schwimmhalle ist ’ne Wolke"
                               "die Feier war ’ne Wolke"
                               "wenn ihr mitkommen würdet, das wäre ’ne Wolke")
                              :definitions nil)))))
         (:source "duden" :lemma "Wol­ke" :ok t :url
                  ("https://www.duden.de/rechtschreibung/Wolke?amp") :homographs
                  ((:id 1 :lemma "Wol­ke" :title "Wol­ke, die" :wortart
                        "Substantiv" :grammar "Substantiv, feminin" :origin
                        "mittelhochdeutsch wolke, althochdeutsch wolka, eigentlich = die Feuchte (d. h. „die Regenhaltige“)"
                        :idioms nil :synonyms ("Schwaden" "Schwall") :url
                        "https://www.duden.de/rechtschreibung/Wolke?amp"
                        :definitions
                        ((:id 1 :duden-id "Bedeutung-1" :label "1" :definition
                              ...
                              :image
                              "https://cdn.duden.de/_media_/full/W/Wolke-201100281474.jpg"
                              :definitions nil)
                         (:id 2 :duden-id "Bedeutung-2" :label "2" :definition
                              ...
                              :idioms nil :image
                              "https://cdn.duden.de/_media_/full/W/Wolke-201100281477.jpg"
                              :definitions nil)
                         (:id 3 :duden-id "Bedeutung-3" :label "3" :definition
                              "(in Bezug auf ein Kleidungsstück) bauschig drapierte Menge Stoff"
                              :qualifiers ("Gebrauch: scherzhaft") :examples
                              ("sie trug eine Wolke von Tüll und Spitzen")
                              :idioms nil :image nil :definitions nil)
                         (:id 4 :duden-id "Bedeutung-4" :label "4" :definition
                              "Ansammlung mikroskopisch kleiner Bläschen oder anderer Einschlüsse (in Edelsteinen)"
                              :qualifiers ("Gebrauch: Mineralogie") :examples
                              nil :idioms nil :image nil :definitions nil)))))
         (:source "wiktionary" :lemma "Wolke" :ok t :url
                  "https://de.wiktionary.org/wiki/Wolke" :homographs
                  ((:id 1 :lemma "Wolke" :title "Wolke, Substantiv, f" :wortart
                        ...
                        :idioms
                        ("aus allen Wolken fallen" "auf Wolke sieben schweben")
                        :synonyms ((:sense "3" :items ("Gaswolke"))) :url
                        "https://de.wiktionary.org/wiki/Wolke" :definitions
                        ((:id 1 :label "1" :definition
                              "große Ansammlung von Wasserteilchen in der Troposphäre"
                              :qualifiers nil :examples
                              ("Der Himmel ist mit Wolken bedeckt."
                               "„In welcher Hinsicht, auf welche Weise können die Wolken und Gletscher der Hochgebirge Schicksal spielen?“"
                               "„Gelbliche Wolken fliegen über den Morgenhimmel.“"
                               "„Es fing bereits an, hell zu werden, die Wolken hatten sich zerteilt, und es regnete nicht mehr.“")
                              :definitions nil)
