        ...
        :sources ((:source "openthesaurus"
                  ...
                  (:source "dwds"
                           ...
                           :homographs ((:id 1
                                             ...
                                             :idioms ("altes Haus"
                                                      ...
                                                      "hinterm Mond zu Hause sein"
                                                      "auf dem Mond zu Hause sein"
                                                      "in etw. zu Hause sein"
                                                      "ins Haus stehen"
                                                      "ist die Katze aus dem Haus, tanzen die Mäuse auf dem Tisch"
                                                      "wenn die Katze aus dem Haus ist, tanzen die Mäuse auf dem Tisch"
                                                      "jmdm. das Haus einrennen"
                                                      "mit der Tür ins Haus fallen"
                                                      "nach Art des Hauses"
                                                      "nicht hinter dem Mond zu Hause sein"
                                                      "nicht hinterm Mond zu Hause sein"
                                                      "um die Häuser ziehen")
                                             :definitions ((:id 1
                                                                :dwds-id "d-1-1"
                                                                :label "1."
                                                                :definition "aus Wänden und Dach errichtetes Gebäude für Menschen"
                                                                :qualifiers nil
                                                                :examples nil
                                                                :definitions ((:id 1
                                                                                   :dwds-id "d-1-1-1"
                                                                                   :label "a)"
                                                                                   :definition "zum Wohnen, Wohnhaus"
                                                                                   :qualifiers nil
                                                                                   :examples ("ein großes, mehrstöckiges, neues, stattliches, modernes, ruhiges, wohnliches, hässliches, baufälliges, abgewohntes, leeres, verlassenes, zerbombtes, abgebranntes Haus"
                                                                                   ...
                                                                                   :definitions ((:id 1
                                                                                                      :dwds-id "d-1-1-1-1"
                                                                                                      :label "α)"
                                                                                                      :definition "das eigene Heim"
                                                                                                      :qualifiers nil
                                                                                                      :examples ("im Haus des Freundes ein- und ausgehen"
                                                                                                                 "eine Einladung, ein Brief flattert ins Haus"
                                                                                                                 "Gäste schneien ins Haus"
                                                                                                                 "Postkarte genügt, komme ins Haus (= Erklärung der Hilfsbereitschaft)"
                                                                                                 ...
                                                                                                 (:id 3
                                                                                                      ...
                                                                                                      :examples ("auf etw., jmdn. Häuser bauen (= sich auf etw., jmdn. fest verlassen, einer Sache, jmdm. fest vertrauen)"
                                                                                                                 "mit der Tür ins Haus fallen (= sein Anliegen plump, ohne Umschweife sagen)"
                                                                                                                 "das (ganze) Haus auf den Kopf stellen (= Unordnung und Lärm machen)"
                                                                                                                 "ganz aus dem Häuschen sein (= aufgeregt, außer sich, übermäßig lustig sein)"
                                                                                                                 "jmdm. das Haus einlaufen (= jmdn. immerzu aufsuchen)")
                                                                                                      :definitions nil)))
                                                                              (:id 2
                                                                                   :dwds-id "d-1-1-2"
                                                                                   :label "b)"
                                                                                   :definition "öffentliches, zweckbestimmtes Gebäude"
                                                                                   :qualifiers nil
                                                                                   :examples ("das Haus der Jugend, des Lehrers, der Jungen Pioniere, der Kultur")
                                                                                   :definitions ((:id 1
                                                                                                      :dwds-id "d-1-1-2-1"
                                                                                                      :label "α)"
                                                                                                      :definition "Theater"
                                                                                                      :qualifiers nil
                                                                                                      :examples ("das Haus war bis auf den letzten Platz gefüllt"
                                                                                                 ...
                                                                                                 (:id 4
                                                                                                      :dwds-id "d-1-1-2-4"
                                                                                                      :label "δ)"
                                                                                                      :definition "Firma, Handelsunternehmen"
                                                                                                      :qualifiers nil
                                                                                                      :examples ("ein Angestellter unseres Hauses wird bei Ihnen vorsprechen"
                                                                                                                 ...
                                                                                                                 "sobald der Konkurs des Hauses B. Grünlich erfolgt")
                                                                                                      :definitions nil)))
                                                                              (:id 3
                                                                                   :dwds-id "d-1-1-3"
                                                                                   :label "c)"
                                                                                   ...
                                                                                   :definitions ((:id 1
                                                                                                      ...
                                                                                                      :qualifiers ("umgangssprachlich"
                                                                                                                   "übertragen")
                                                                                                      :examples ("in der Lausitz sind noch heute viele alte Bräuche zu Hause (= üblich)"
                                                           ...
                                                           (:id 2
                                                                :dwds-id "d-1-2"
                                                                :label "2."
                                                                :definition "die Gesamtheit der zu 1 gehörenden Personen"
                                                                :qualifiers nil
                                                                :examples nil
                                                                :definitions ((:id 1
                                                                                   :dwds-id "d-1-2-1"
                                                                                   :label "a)"
                                                                                   :definition "alle Bewohner eines Hauses"
                                                                                   :qualifiers ("umgangssprachlich")
                                                                                   :examples ("das ganze Haus ist verreist"
                                                                              ...
                                                                              (:id 2
                                                                                   ...
                                                                                   :definition "Familie"
                                                                                   :qualifiers nil
                                                                                   :examples ("der Herr des Hauses (= das Familienoberhaupt) (= der Gastgeber)"
                                                                                              ...
                                                                                              "der Reisende gewann Einblick in die besten Häuser (= die vornehmsten Familien) der Stadt"
                                                                                              "Grüße von Haus zu Haus senden")
                                                                                   :definitions nil)
                                                                              (:id 3
                                                                                   :dwds-id "d-1-2-3"
                                                                                   :label "c)"
                                                                              ...
                                                                              (:id 4
                                                                                   :dwds-id "d-1-2-4"
                                                                                   :label "d)"
                                                                                   :definition "Zuhörerschaft (im Theater)"
                                                                                   :qualifiers nil
                                                                                   :examples ("vor vollem Haus sprechen"
                                                                              ...
                                                                              (:id 5
                                                                                   :dwds-id "d-1-2-5"
                                                                                   :label "e)"
                                                                                   :definition "Volksvertretung, Ständevertretung, Parlament"
                                                                                   :qualifiers nil
                                                                                   :examples ("das Haus tritt zusammen, ist beschlussfähig, tritt in die Tagesordnung ein"
                                                           ...
                                                           (:id 3
                                                                :dwds-id "d-1-3"
                                                                :label "3."
                                                                :definition "Hauswesen, Wirtschaft einer Familie"
                                                                :qualifiers nil
                                                                :examples ("ein gastliches, offenes Haus haben"
                                                           ...
                                                           (:id 4
                                                                :dwds-id "d-1-4"
                                                                :label "4."
                                                                :definition "Gehäuse der Schnecke"
                                                                :qualifiers ("umgangssprachlich")
                                                                :examples ("die Schnecke zog ihre Fühler ein und kroch in ihr Haus")
                                                                :definitions nil)
                                                           (:id 5
                                                                :dwds-id "d-1-5"
                                                                :label "5."
                  ...
                  (:source "duden"
                           ...
                           :homographs ((:id 1
                                             ...
                                             :title "Haus, das"
                                             :wortart "Substantiv"
                                             :grammar "Substantiv, Neutrum"
                                             :origin "mittelhochdeutsch, althochdeutsch hūs, eigentlich = das Bedeckende, Umhüllende"
                                             :idioms nil
                                             :synonyms ("Anwesen"
                                                        "Bau"
                                                        "Bauwerk"
                                             ...
                                             :definitions ((:id 1
                                                                ...
                                                                :definitions ((:id 1
                                                                                   ...
                                                                                   :qualifiers nil
                                                                                   :examples ("ein großes, kleines, altes, mehrstöckiges, verwinkeltes Haus"
                                                                                              ...
                                                                                              "das väterliche Haus")
                                                                                   :idioms ("Haus und Hof (der gesamte Besitz: er hat Haus und Hof verspielt, vertrunken)"
                                                                                            "[jemandem] ins Haus stehen (umgangssprachlich: [jemandem] bevorstehen: eine Neuerung steht [ihm] ins Haus)")
                                                                                   :image "https://cdn.duden.de/_media_/full/H/Haus-201020510799.jpg"
                                                                                   :definitions nil)
                                                                              (:id 2
                                                                                   :duden-id "Bedeutung-1b"
                                                                                   :label "1b"
                                                                                   :definition "Gebäude, das zu einem bestimmten Zweck errichtet wurde"
                                                                                   :qualifiers nil
                                                                                   :examples ("das große (besonders für Aufführungen von Opern, großen Schauspielen o. Ä. bestimmte), kleine (besonders für kleinere Bühnenstücke bestimmte) Haus des Theaters war bis auf den letzten Platz ausverkauft"
                                                                                   ...
                                                                                   :definitions nil)
                                                                              (:id 3
                                                                                   :duden-id "Bedeutung-1c"
                                                                                   :label "1c"
                                                                                   :definition "Wohnung, Heim, in dem jemand ständig lebt"
                                                                                   :qualifiers nil
                                                                                   :examples ("jemandem das/sein Haus verbieten, öffnen"
                                                           ...
                                                           (:id 2
                                                                ...
                                                                :definitions ((:id 1
                                                                                   ...
                                                                                   :examples ("das Haus war vollzählig versammelt"
                                                                              ...
                                                                              (:id 2
                                                                                   ...
                                                                                   :label "2b"
                                                                                   :definition "Gesamtheit von Personen, die sich in einer bestimmten Funktion in einem bestimmten Haus (1b) aufhalten, dort tätig sind"
                                                                                   :qualifiers nil
                                                                                   :examples ("das Hohe Haus (das Parlament)"
                                                                                   ...
                                                                                   :definitions nil)
                                                                              (:id 3
                                                                                   :duden-id "Bedeutung-2c"
                                                                                   :label "2c"
                                                                                   :definition "Familie"
                                                                                   :qualifiers ("Gebrauch: gehoben")
                                                                                   :examples ("ein gastliches, bürgerliches, angesehenes Haus"
                                                                                   ...
                                                                                   :idioms ("von Haus[e] aus (1. von der Familie her: von Haus[e] aus ist sie sehr begütert. 2. seit jeher, von Natur aus: von Haus[e] aus ist er schüchtern. 3. ursprünglich, eigentlich: von Haus[e] aus ist er Tischler.)")
                                                                                   :image nil
                                                                                   :definitions nil)
                                                                              (:id 4
                                                                                   :duden-id "Bedeutung-2d"
                                                                                   :label "2d"
                                                                                   :definition "Haushalt, Wirtschaft, Hauswesen einer Familie"
                                                                                   :qualifiers nil
                                                                                   :examples ("jemandem das Haus besorgen"
                                                                                              "ein großes Haus führen (häufig Gäste haben und sie aufwendig bewirten)"
                                                                                              "jemanden ins Haus nehmen")
                                                                                   :idioms ("Haus und Herd (eigener Hausstand)"
                                                                                   ...
                                                                                   :definitions nil)))
                                                           (:id 3
                                                                :duden-id "Bedeutung-3"
                                                                :label "3"
                                                                :definition "Dynastie, [Herrscher]geschlecht"
                                                                :qualifiers nil
                                                                :examples ("das Haus Davids"
                                                           ...
                                                           (:id 4
                                                                ...
                                                                :qualifiers ("Gebrauch: umgangssprachlich scherzhaft")
                                                                :examples ("er ist ein fideles, gemütliches, gelehrtes Haus"
                                                           ...
                                                           (:id 5
                                                                ...
                                                                :image nil
                                                                :definitions ((:id 1
                                                                                   :duden-id "Bedeutung-5a"
                                                                                   :label "5a"
                                                                                   :definition "Tierkreiszeichen in seiner Zuordnung zu einem Planeten"
                                                                                   ...
                                                                                   :definitions nil)
                                                                              (:id 2
                                                                                   :duden-id "Bedeutung-5b"
                                                                                   :label "5b"
                                                                                   :definition "einer der zwölf Abschnitte, in die der Tierkreis eingeteilt ist"
                                                                                   :qualifiers ("Gebrauch: Astrologie")
                                             ...
                                             :synonyms ((:sense "1"
                                                        ...
                                                        (:sense "7"
                                                                :items ("Familie"
                                                                        ...
                                                                        "Blase"))
                                                        (:sense "8"
                                                                :items ("Haushalt" "Hausstand"))
                                                        (:sense "12"
                                                                :items ("Domizil"))
                                                        (:sense "4"
                                                                :items ("Hausgemeinschaft"
                                                                        "Hausgenossenschaft"))
                                                        (:sense "9"
                                                                :items ("Adelsgeschlecht"
                                                                        "Dynastie"
                                                                        "Fürstengeschlecht"
                                                                        "Herrschergeschlecht"
                                                                        "Königsgeschlecht"))
                                                        (:sense "10"
                                                                :items ("Coquille"
                                                                        ...
                                                                        "Schulp"))
                                                        (:sense "11"
                                                                :items ("Cochlea" "Konchylie")))
                                             :url "https://de.wiktionary.org/wiki/Haus"
                                             :definitions ((:id 1
                                                                :label "1"
                                                                :definition "zu einem bestimmten Zweck erbautes Gebäude"
                                                                :qualifiers nil
                                                                :examples ("„‚Wir dürften in München die größte Auswahl haben‘, sind sie überzeugt und auch davon, dass ihr Haus besten Service bietet.“"
                                                           ...
                                                           (:id 2
                                                                :label "2"
                                                                :definition "zum Wohnen dienendes und genutztes Gebäude"
                                                                :qualifiers nil
                                                                :examples ("Das Haus steht seit 1898."
                                                           ...
                                                           (:id 3
                                                                :label "3"
                                                                :definition "aus mehreren Räumen bestehender, abgetrennter Bereich innerhalb eines unter beschriebenen Gebäudes, in dem sich eine oder mehrere Personen ständig aufhalten können, leben"
                                                                :qualifiers nil
                                                                :examples ("Mein Haus wird gerade renoviert."
                                                           ...
                                                           (:id 4
                                                                :label "4"
                                                                :definition "umgangssprachlich: Gesamtheit der Bewohner in dem unter beschriebenen Gebäude"
                                                                :qualifiers nil
                                                                :examples ("„Unser Haus versammelte sich im Betsale.“")
                                                                :definitions nil)
                                                           (:id 5
                                                                :label "5"
                                                                :definition "Gesamtheit der Personen, die sich in einem bestimmten Amt, in einer bestimmten Stellung oder Tätigkeit in einem unter beschriebenen Gebäude aufhalten oder dort einer Beschäftigung nachgehen"
                                                                :qualifiers nil
                                                                :examples ("Er ist durchaus in der Lage, ein großes Haus zu leiten."
                                                           ...
                                                           (:id 6
                                                                :label "6"
                                                                :definition "gesetzgebende Körperschaft der Volksvertretung"
                                                                :qualifiers nil
                                                                :examples ("„Binnen weniger Stunden entschärften beide Häuser des Parlaments einen umstrittenen Artikel und stärkten so die Demokratie.“")
                                                                :definitions nil)
                                                           (:id 7
                                                                :label "7"
                                                                :definition "gehoben: im selben unter beschriebenen Gebäude/im selben unter beschriebenen Bereich lebende Gemeinschaft aus einem Elternpaar oder einem Elternteil samt mindestens einem Kind"
                                                                :qualifiers nil
                                                                :examples ("Dies ist ein ehrenwertes Haus."
                                                           ...
                                                           (:id 8
                                                                :label "8"
                                                                :definition "Hauswesen der unter beschriebenen Gemeinschaft"
                                                                :qualifiers nil
                                                                :examples ("„Als sie die schmale Kost verzehrt hatten, legten sie sich zu Bett: aber am Morgen trieb er sie schon ganz früh heraus, weil sie das Haus besorgen sollte.“"
                                                           ...
                                                           (:id 9
                                                                :label "9"
                                                                :definition "eine Reihe von adligen (angesehenen) Persönlichkeiten, Herrschern hervorgebrachtes Geschlecht"
                                                                :qualifiers nil
                                                                :examples ("Man sieht es ihm nicht an, aber er kommt aus einem königlichen Haus."
                                                                           "„Ist er wirklich der Prinz aus regierendem Hause, den ruchlose Verwandte in der Wildnis ausgesetzt haben?“")
                                                                :definitions nil)
                                                           (:id 10
                                                                :label "10"
                                                                :definition "umgangssprachlich, scherzhaft: Mensch, Person"
                                                                :qualifiers nil
                                                                :examples ("„Eigentlich wollen sie nur zeigen, was für gelehrte, gescheite Häuser, für geistreiche Köpfe, für enorme Könner sie sind.“"
                                                           ...
                                                           (:id 11
                                                                :label "11"
                                                                :definition "umgangssprachlich, veraltet, fachsprachlich, Zoologie: bestimmte Tiere (vor allem Weichtiere wie Gastropoden) umgebende feste, panzerartige, schützende Umhüllung"
                                                                :qualifiers nil
                                                                :examples ("Die Schnecke trägt ihr Haus mit sich."
                                                           ...
                                                           (:id 12
                                                                :label "12"
                                                                :definition "Astrologie, fachsprachlich: Tierkreiszeichen in seiner Zuordnung zu einem Planeten"
                                                                :qualifiers nil
                                                                :examples ("„ Es bestehen systematische Analogien zwischen Planeten, Zeichen, Häusern und Winkelbeziehungen: Jedes Haus ist beispielsweise einem Tierkreiszeichen zugeordnet.“")
                                                                :definitions nil)
                                                           (:id 13
                                                                :label "13"
                                                                :definition "Astrologie, fachsprachlich: einer der zwölf Abschnitte, in die der Tierkreis eingeteilt ist"
                                                                :qualifiers nil
                                                                :examples ("Jedes der zwölf astrologischen Häuser entspricht einem bestimmten Bereich des alltäglichen Lebens, auf denen die Energie eines Planeten zum Ausdruck kommt."
                                                                           "„Ausgehend vom Aszendenten und den zwei Hauptachsen, werden nun die zwölf astrologischen Häuser berechnet.“")
                                                                :definitions nil)
                                                           (:id 14
                                                                :label "14"
                                                                :definition "Handwerk, fachsprachlich: mittlerer Teil eines Hammerkopfes"
                                                                :qualifiers nil
                                                                :examples ("„Hammer mit verbreiterter, stumpfer Finne, hohem, unregelmäßig ausgewölbtem Haus und schlankem Hammerteil mit gestauchter Bahn.“"
                                                           ...
                                                           (:id 15
                                                                :label "15"
                                                                :definition "Curling, fachsprachlich: die drei konzentrischen Kreise, in denen Punkte erzielt werden können, die vom Kreis mit dem Radius von 6 ′ umschlossene Fläche"
                                                                :qualifiers nil
                                                                :examples ("„Pro Stein, der näher zur Mitte des Hauses liegt als der Stein des Gegners, gibt es einen Punkt.“"
