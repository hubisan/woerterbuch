(:input "Zaun" :lemma "Zaun" :sources
        ((:source openthesaurus :lemma "Zaun" :ok t :url
                  "https://www.openthesaurus.de/synonyme/Zaun" :homographs
                  ((:id 1 :lemma "Zaun" :definitions
                        ((:id 1 :lemma "Zaun" :categories nil :synonyms
                              ("Einzäunung" "Umzäunung" "Fenz"))
                         (:id 2 :lemma "Zaun" :categories nil :synonyms
                              ("Gatter" "Gitter"))))))
         (:source dwds :lemma "Zaun" :ok t :url "https://www.dwds.de/wb/Zaun"
                  :homographs
                  ((:id 1 :hidx "" :lemma "Zaun" :title "Zaun, der" :wortart
                        "Substantiv" :grammar
                        "Substantiv (Maskulinum) · Genitiv Singular: Zaun(e)s · Nominativ Plural: Zäune"
                        :origin
                        ...
                        ("das Gras ist grüner auf der anderen Seite"
                         ...
                         "etw. vom Zaun brechen" "etw. vom Zaune brechen"
                         "mit etw. nicht hinterm Zaun halten"
                         "mit etw. nicht hinter dem Zaun halten"
                         "nicht mehr alle Latten am Zaun haben")
                        :definitions
                        ((:id 1 :dwds-id "d-1-1" :label "" :definition
                              ...
                              ("ein Zaun aus Latten, Maschendraht"
                               ...
                               "sie trafen sich zu einem nachbarlichen Schwatz über den Zaun"
                              ...
                              :definitions
                              ((:id 1 :dwds-id "d-1-1-1" :label "●" :definition
                                    "einen Streit, Krieg vom Zaune brechen (MWA) = einen Streit, Krieg unvermittelt heraufbeschwören"
         ...
         (:source wiktionary :lemma "Zaun" :ok t :url
                  ...
                  ((:id 1 :lemma "Zaun" :title "Zaun, Substantiv, m" :wortart
                        ...
                        :idioms
                        ("ein lebender Zaun"
                         "mit etwas hinter dem Zaun halten / mit etwas hinterm Zaun halten"
                         "etwas vom Zaun brechen / gehoben: etwas vom Zaune brechen"
                         "den Zaun nicht einreißen" "durch den Zaun grasen"
                         ...
                         "übern Zaun gehen" "Wind über den Zaun schaufeln"
                         "Wir werden den Zaun schon pinseln !")
                        :synonyms
                        ((:sense "1" :items
                                 ("Abzäunung" "Einfriedigung" "Einfriedung"
                                  "Einzäunung" "Umzäunung" "Befriedung"
                                  "Umfriedigung" "Umfriedung" "Einhegung" "Hag"
                                  "Fence" "Fenz" "Eingrenzung" "Gatter" "Gitter"
                                  "Hecke" "Palisade")))
                        :url "https://de.wiktionary.org/wiki/Zaun" :definitions
                        ((:id 1 :label "1" :definition
                              ...
                              ("Viele Menschen frieden ihr Grundstück mit einem Zaun ein."
                               "„Es blieb nicht aus, daß wir dann vor dem Zaun standen.“"
                               "„Und die Kosaken sahen sich erstaunt nach Denissow um, als er sich mit einigen nach Hundegebell klingenden Lauten rasch abwandte, an den Zaun ging und sich gegen ihn lehnte.“"
