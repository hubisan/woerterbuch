(:input "verliebt" :lemma "verlieben" :sources
	((:source openthesaurus :lemma "verlieben" :ok nil :homographs
		  nil :error "No matches found" :url
	 ...
	 (:source dwds :lemma "verlieben" :ok t :url
		  ...
		  ((:id 1 :hidx "" :lemma "verlieben" :title
			"verlieben" :wortart "Verb" :grammar
	 ...
	 (:source duden :lemma "ver­lie­ben" :ok t :url
		  ...
		  :homographs
		  ((:id 1 :lemma "ver­lie­ben" :title "ver­lie­ben"
			:wortart "schwaches Verb" :grammar
			"schwaches Verb" :origin nil :idioms nil
			:synonyms
			("Feuer fangen"
	 ...
	 (:source wiktionary :lemma "verlieben" :ok t :url
		  "https://de.wiktionary.org/wiki/verlieben"
		  :homographs
		  ((:id 1 :lemma "verlieben" :title "verlieben, Verb"
			:wortart "Verb" :grammar "Verb" :origin
			"Ableitung zu lieben mit dem Derivatem (Ableitungsmorphem) ver-"
			:idioms nil :synonyms
			((:sense "1" :items
				 ("vergucken" "verknallen"
				  "verschießen")))
			:url
			"https://de.wiktionary.org/wiki/verlieben"
			:definitions
