(:input "Haus" :lemma "Haus" :sources
	((:source openthesaurus :lemma "Haus" :ok t :url
		  ...
		  :homographs
		  ((:id 1 :lemma "Haus" :definitions
			((:id 1 :lemma "Haus" :categories nil
			      :synonyms
			      ("Haus..." "hausintern" "inhäusig"
			       "inhouse" "innerbetrieblich" "intern"
			       "firmenintern"))
			 (:id 2 :lemma "Haus" :categories nil
			      :synonyms
			      ("Heim" "Behausung" "Bude" "Hütte"))
			 (:id 3 :lemma "Haus" :categories nil
			      :synonyms
			      ("Familie" "Familienbande" "Geblüt"
			       "Geschlecht" "Sippe" "Stamm"
			       "Mischpoke"))
			 (:id 4 :lemma "Haus" :categories nil
			      :synonyms
			      ("Bungalow" "(eingeschossiges) Haus"))
			 (:id 5 :lemma "Haus" :categories nil
			      :synonyms
			      ("Betriebs..." "betriebseigen"
			       "betriebsintern" "firmenintern"
			       "Haus..." "hauseigen" "vor Ort"))
			 (:id 6 :lemma "Haus" :categories nil
			      :synonyms
			      ("bewährt" "(jemandes) Haus..."
			       "langjährig" "... meines Vertrauens"
			       "(jemandes) Haus- und Hof-..."
			       "(jemandes) Leib-und-Magen-..."))
			 (:id 7 :lemma "Haus" :categories nil
			      :synonyms
			      ("Geschäft" "Laden (...laden)"
			       "Handel (für ..., ...handel)"
			       "Handlung (...handlung)" "...haus"
			       "Kauf(manns)laden" "Ladengeschäft"
			       "...markt" "Shop (...shop)" "Store"
			       "Detailgeschäft"
			       "Einzelhandelsgeschäft"))
			 (:id 8 :lemma "Haus" :categories nil
			      :synonyms
			      ("Anwesen" "Domaine"
			       "Finca (span., südamer.)" "Herrenhaus"
			       "Landgut" "Landhaus" "Landsitz" "Manor"
			       "Villa"))
			 (:id 9 :lemma "Haus" :categories nil
			      :synonyms
			      ("Ministerium"
			       "(das) Haus (+ Ministername)"))))))
	 (:source dwds :lemma "Haus" :ok t :url
		  "https://www.dwds.de/wb/Haus" :homographs
		  ((:id 1 :hidx "" :lemma "Haus" :title "Haus, das"
			...
			((:id 1 :dwds-id "d-1-1" :label "1."
			      ...
			      ((:id 1 :dwds-id "d-1-1-1" :label "a)"
				    ...
				    ((:id 1 :dwds-id "d-1-1-1-1"
					  ...
					  :definitions nil)
				     (:id 2 :dwds-id "d-1-1-1-2"
					  :label "β)" :definition
					  "⟨ frei Haus ⟩" :qualifiers
					  nil :examples
					  ("die Kohlen, Kartoffeln frei Haus liefern")
					  :definitions nil)
				     (:id 3 :dwds-id "d-1-1-1-3"
					  :label "γ)" :definition ""
					  ...
					  :definitions nil)))
			       (:id 2 :dwds-id "d-1-1-2" :label "b)"
				    :definition
				    "öffentliches, zweckbestimmtes Gebäude"
				    :qualifiers nil :examples
				    ("das Haus der Jugend, des Lehrers, der Jungen Pioniere, der Kultur")
				    :definitions
				    ((:id 1 :dwds-id "d-1-1-2-1"
					  :label "α)" :definition
					  "Theater" :qualifiers nil
					  :examples
					  ("das Haus war bis auf den letzten Platz gefüllt"
					   "unser Haus ist ausverkauft")
					  :definitions nil)
				     (:id 2 :dwds-id "d-1-1-2-2"
					  :label "β)" :definition
					  "Hotel" :qualifiers nil
					  :examples
					  ("Haus Waldfrieden"
					   "Haus Seeblick"
					   "Deutsches Haus"
					   "das erste Haus am Platz")
					  :definitions nil)
				     (:id 3 :dwds-id "d-1-1-2-3"
					  :label "γ)" :definition
					  "Ferienheim" :qualifiers
					  ("DDR") :examples nil
					  :definitions nil)
				     (:id 4 :dwds-id "d-1-1-2-4"
					  :label "δ)" :definition
					  ...
					  :definitions nil)))
			       (:id 3 :dwds-id "d-1-1-3" :label "c)"
				    :definition
				    "⟨ nach Hause, zu Hause ⟩ dort, dorthin, wo man (ständig) wohnt, heim"
				    :qualifiers nil :examples
			 ...
			 (:id 2 :dwds-id "d-1-2" :label "2."
			      ...
			      ((:id 1 :dwds-id "d-1-2-1" :label "a)"
			       ...
			       (:id 2 :dwds-id "d-1-2-2" :label "b)"
				    ...
				    :definitions nil)
			       (:id 3 :dwds-id "d-1-2-3" :label "c)"
				    :definition "Dynastie" :qualifiers
				    nil :examples
				    ("Haus Habsburg"
				     "Haus Hohenzollern" "Haus Wettin"
				     "das Königliche Haus (= die Königliche Familie)")
				    :definitions nil)
			       (:id 4 :dwds-id "d-1-2-4" :label "d)"
				    :definition
	 ...
	 (:source duden :lemma "Haus" :ok t :url
		  ...
		  :homographs
		  ((:id 1 :lemma "Haus" :title "Haus, das" :wortart
			"Substantiv" :grammar "Substantiv, Neutrum"
			:origin
			...
			((:id 1 :duden-id nil :label "1" :definition
			      ...
			      ((:id 1 :duden-id "Bedeutung-1a" :label
			       ...
			       (:id 3 :duden-id "Bedeutung-1c" :label
				    "1c" :definition
			 ...
			 (:id 2 :duden-id nil :label "2" :definition
			      ...
			      ((:id 1 :duden-id "Bedeutung-2a" :label
			       ...
			       (:id 2 :duden-id "Bedeutung-2b" :label
				    ...
				    :idioms nil :image nil
				    :definitions nil)
			       (:id 3 :duden-id "Bedeutung-2c" :label
				    "2c" :definition "Familie"
				    ...
				    :image nil :definitions nil)
			       (:id 4 :duden-id "Bedeutung-2d" :label
				    "2d" :definition
				    ...
				    :image nil :definitions nil)))
			 (:id 3 :duden-id "Bedeutung-3" :label "3"
			      :definition
			 ...
			 (:id 4 :duden-id "Bedeutung-4" :label "4"
			      :definition "Person, Mensch" :qualifiers
			      ("Gebrauch: umgangssprachlich scherzhaft")
			      :examples
			      ("er ist ein fideles, gemütliches, gelehrtes Haus"
			       "wie gehts, altes Haus (alter Freund)")
			      :idioms nil :image nil :definitions nil)
			 (:id 5 :duden-id nil :label "5" :definition
			      nil :qualifiers nil :examples nil
			      :idioms nil :image nil :definitions
			      ((:id 1 :duden-id "Bedeutung-5a" :label
				    "5a" :definition
				    "Tierkreiszeichen in seiner Zuordnung zu einem Planeten"
				    :qualifiers
				    ("Gebrauch: Astrologie") :examples
				    nil :idioms nil :image nil
				    :definitions nil)
			       (:id 2 :duden-id "Bedeutung-5b" :label
				    "5b" :definition
				    ...
				    :idioms nil :image nil
				    :definitions nil)))))))
	 (:source wiktionary :lemma "Haus" :ok t :url
		  "https://de.wiktionary.org/wiki/Haus" :homographs
		  ((:id 1 :lemma "Haus" :title "Haus, Substantiv, n"
			:wortart "Substantiv" :grammar "Substantiv"
			:origin
			...
			("auf jemanden Häuser bauen können"
			 ...
			 "Haus auf Rädern" "Haus der offenen Tür"
			 ...
			 "Haus ohne Hüter" "aus dem Haus sein"
			 "das Haus hüten"
			 ...
			 "Haus und Herd" "Haus halten"
			 "familiär: altes Haus" "bemoostes Haus"
			 "fesches Haus" "zünftiges Haus"
			...
			((:sense "1" :items
			 ...
			 (:sense "2" :items
				 ("Winde" "Affenkasten" "Kasten"
				  "Wohnhaus" "Wohngebäude" "Tempel"
				  "Spelunke" "Bleibe" "Klause" "Logis"
				  "Quartier" "Unterkunft" "Unterstand"
				  "Aufenthalt" "Behausung"
				  "Wohnstätte" "Wohnstatt" "Domizil"
				  "Obdach" "Nest" "Bude"
				  "Dach über dem Kopf" "Unterbringung"
				  "Affenstall" "Hundeloch" "Penne"
				  "Losament" "Logement"))
			 (:sense "3" :items
				 ("Heim" "Wohnung" "Zuhause" "Tempel"
				  "Spelunke" "Bleibe" "Klause" "Logis"
				  "Quartier" "Unterkunft" "Unterstand"
				  "Aufenthalt" "Behausung"
				  "Wohnstätte" "Wohnstatt" "Domizil"
			 ...
			 (:sense "7" :items
				 ("Familie" "Gepäck" "Mischpoke"
				  "Anhang" "Kaninchenstall" "Kinderei"
				  "Krawallhaufen" "Paket" "Seilschaft"
				  "die ganze Vanille" "Bagage"
				  "Sippschaft" "Clan" "Sippe" "Blase"))
			 (:sense "8" :items ("Haushalt" "Hausstand"))
			 (:sense "12" :items ("Domizil"))
			 (:sense "4" :items
				 ("Hausgemeinschaft"
				  "Hausgenossenschaft"))
			 (:sense "9" :items
				 ("Adelsgeschlecht" "Dynastie"
				  "Fürstengeschlecht"
				  "Herrschergeschlecht"
				  "Königsgeschlecht"))
			 (:sense "10" :items
				 ("Coquille" "Muschel" "Muschelschale"
				  "Gehäuse" "Schale" "Schulp"))
			 (:sense "11" :items ("Cochlea" "Konchylie")))
			...
			((:id 1 :label "1" :definition
			 ...
			 (:id 4 :label "4" :definition
			      "umgangssprachlich: Gesamtheit der Bewohner in dem unter beschriebenen Gebäude"
			      :qualifiers nil :examples
			 ...
			 (:id 9 :label "9" :definition
			      ...
			      :definitions nil)
			 (:id 10 :label "10" :definition
			      "umgangssprachlich, scherzhaft: Mensch, Person"
			      :qualifiers nil :examples
			 ...
			 (:id 14 :label "14" :definition
			      ...
			      :definitions nil)
			 (:id 15 :label "15" :definition
			      "Curling, fachsprachlich: die drei konzentrischen Kreise, in denen Punkte erzielt werden können, die vom Kreis mit dem Radius von 6 ′ umschlossene Fläche"
			      :qualifiers nil :examples
