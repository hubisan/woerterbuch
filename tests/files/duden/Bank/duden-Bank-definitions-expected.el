(:input "Bank" :lemma "Bank" :sources
        ((:source duden :lemma "Bank" :ok t :url
                  ...
                  ((:id 1 :lemma "Bank" :title "Bank, die" :wortart "Substantiv"
                        :grammar "Substantiv, feminin" :origin nil :idioms nil
                        :synonyms nil :url
                        "https://www.duden.de/rechtschreibung/Bank_Sitzgelegenheit?amp"
                        :definitions
                        ((:id 1 :duden-id nil :label "1" :definition nil
                              ...
                              ((:id 1 :duden-id "Bedeutung-1a" :label "1a"
                                    ...
                                    :qualifiers nil :examples nil :idioms nil
                                    :image
                               ...
                               (:id 2 :duden-id "Bedeutung-1b" :label "1b"
                                    ...
                                    ("Gebrauch: Sport") :examples nil :idioms
                                    nil :image
                         ...
                         (:id 3 :duden-id nil :label "3" :definition nil
                              ...
                              ((:id 1 :duden-id "Bedeutung-3a" :label "3a"
                               ...
                               (:id 4 :duden-id "Bedeutung-3d" :label "3d"
                                    ...
                                    :qualifiers ("Gebrauch: Geologie") :examples
                         ...
                         (:id 5 :duden-id "Bedeutung-5" :label "5" :definition
                              ...
                              :qualifiers ("Gebrauch: Sport") :examples nil
                              :idioms nil :image nil :definitions nil)))
                   (:id 2 :lemma "Bank" :title "Bank, die" :wortart "Substantiv"
                        :grammar "Substantiv, feminin" :origin nil :idioms nil
                        :synonyms nil :url
                        "https://www.duden.de/rechtschreibung/Bank_Geldinstitut?amp"
                        :definitions
                        ((:id 1 :duden-id nil :label "1" :definition nil
                         ...
                         (:id 2 :duden-id "Bedeutung-2" :label "2" :definition
                              ...
                              :qualifiers ("Gebrauch: Glücksspiel") :examples
                              nil :idioms nil :image nil :definitions nil)))))))
