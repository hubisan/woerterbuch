(:input "Bank" :lemma "Bank" :sources
        ((:source wiktionary :lemma "Bank" :ok t :url
                  ...
                  ((:id 1 :lemma "Bank" :title "Bank, Substantiv, f, Bänke"
                        :wortart "Substantiv" :grammar "Substantiv" :origin nil
                        :idioms nil :synonyms
                        ((:sense "2" :items ("Lage"))
                         (:sense "5" :items ("Theke" "Tresen"))
                         (:sense "6" :items ("Auswechselbank" "Ersatzbank")))
                        :url "https://de.wiktionary.org/wiki/Bank" :definitions
                   ...
                   (:id 2 :lemma "Bank" :title "Bank, Substantiv, f, Banken"
                        ...
                        :idioms nil :synonyms
                        ((:sense "1" :items
                                 ("Geldhaus" "Geldinstitut" "Finanzinstitut"
                                  "Finanzunternehmen" "Kreditinstitut"
                                  "Bankhaus"))
